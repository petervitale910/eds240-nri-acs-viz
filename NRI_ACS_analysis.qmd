...
ggplot(nri_county_race,
       aes(y = estimate, 
           ...
           width= .5, 
           fill = label))+
  geom_histogram(position="fill", # I use fill and identity to make a proportion
                 stat="identity")+
  scale_fill_manual(values = c("#448aff", # Scale the color with coolors color scale
                               ...
                               "#ad1457"))+
  # Update the labels
  labs(x = 'Composite National Risk Index Score', 
       y = 'Population Proportion',
       fill = 'Race/Ethnicity',
       title = 'Composite National Risk Index Score In California',
       subtitle = 'Scores plotted with proportions of total population',
